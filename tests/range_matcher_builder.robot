...
*** Test Cases ***
Verify RowPattern Builder Chaining
    [Documentation]    Verify RowPattern methods return the self instance to support chaining.
...
Verify Cell Cardinality Exclusivity Error
    ...
    ${pattern}=    Evaluate    tabularix.RowPattern().empty()    modules=tabularix
