...
Verify Mismatching Column Count Error
    ...
    ${sheet}=    Load Simple Sheet
    ${data}=    Evaluate    tabularix.Range(1, 2, 0, 2)    modules=tabularix
    ${header}=    Evaluate    tabularix.Range(0, 0, 0, 1)    modules=tabularix
